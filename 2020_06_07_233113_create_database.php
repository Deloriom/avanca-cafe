...
class CreateDatabase extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('analise_solo', function (Blueprint $table) {
            ...
            $table->decimal('resina', 10, 2)->nullable(); // Resina
            $table->decimal('p_rem', 10, 2)->nullable(); // fosforo remanecente
            $table->decimal('ctc', 10, 2)->nullable(); // capacidade de troca de cátions
            $table->decimal('s', 10, 2)->nullable(); // Fosfato monocálcico ác. acético
            $table->decimal('agua_quente', 10, 2)->nullable(); // agua quente
            $table->decimal('na', 10, 2)->nullable(); // sodio
